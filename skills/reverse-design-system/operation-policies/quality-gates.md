...
* \[PASS] colors\_and\_type.css exists and is non-empty
...
* \[PASS] All preview HTML files use correct CSS link path (../colors\_and\_type.css)
...
* \[PASS] ui\_kits/marketing/index.html exists

* \[PASS] UIKit uses correct CSS link path (../../colors\_and\_type.css)
